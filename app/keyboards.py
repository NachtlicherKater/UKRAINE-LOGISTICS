...
glava1 = InlineKeyboardMarkup(inline_keyboard= [
    ...
    [InlineKeyboardButton(text='§1.3  На цьому сервері немає жодних утисків, жорстких заборон(в межах розумного) або дискримінації інших національностей та/або мов. Основна мова спілкування в голосовому або текстовому чаті - Українська, але ніхто не забороняє Вам використовувати будь-яку іншу мову, якщо більшість учасників компанії не проти її використання.', callback_data='r13')],
    ...
    [InlineKeyboardButton(text='§1.6  Ставтеся до інших так само, як і до себе. Будь-який прояв неадекватної поведінки НЕПРИПУСТИМИЙ і буде каратися на розсуд Адміністрації, аж до виключення учасника з компанії.',  callback_data='r16')],
    [InlineKeyboardButton(text='§1.7  Новоприбулий учасник повинен вписати нікнейм у Дискорді аналогічний ігровому та ознайомитися із розділом правил.',  callback_data='r17')],
    [InlineKeyboardButton(text='§1.8  Заборонено навмисно заважати проїзду, підрізати, блокувати дорогу та будь-яким чином порушувати правила TruckersMP стосовно інших учасників дорожнього руху, та також своєї компанії.',  callback_data='r18')],
...
glava2 = InlineKeyboardMarkup(inline_keyboard= [
    ...
    [InlineKeyboardButton(text='§2.8  Заборонено ігнорувати та навмисно приховувати інформацію від Адміністрації.',  callback_data='r28')],
    [InlineKeyboardButton(text='ㅤПовернутися назад.ㅤ', callback_data='pravila')]
    ])
